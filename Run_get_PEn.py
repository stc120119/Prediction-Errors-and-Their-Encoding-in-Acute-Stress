...
import pandas as pd
from Function_get_PE_n import process_noise_info

# 创建保存输出的文件夹
output_dir = r"D:\paper2\up_data code and data\PEn_event"
...
for file_path in input_files:
    ...
    output_file = os.path.join(output_dir, f"{subject_id}_PEn.csv")
